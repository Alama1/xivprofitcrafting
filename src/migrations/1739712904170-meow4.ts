...
export class Meow41739712904170 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "ingredient" DROP COLUMN "ingredientItemPriceId"`
    );
    await queryRunner.query(`ALTER TABLE "ingredient" ADD "recipe_id" integer`);
    await queryRunner.query(
      `ALTER TABLE "ingredient" ADD "ingredient_item_price_id" integer`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "ingredient" ADD CONSTRAINT "FK_33ce535a2d6ba1ab1756e0c3d5e" FOREIGN KEY ("ingredient_item_price_id") REFERENCES "prices"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "ingredient" DROP CONSTRAINT "FK_33ce535a2d6ba1ab1756e0c3d5e"`
    );
    await queryRunner.query(
      `ALTER TABLE "ingredient" DROP CONSTRAINT "FK_1a884e9b70245ac229ded0d8248"`
    );
    await queryRunner.query(
      `ALTER TABLE "ingredient" DROP COLUMN "ingredient_item_price_id"`
    );
    await queryRunner.query(`ALTER TABLE "ingredient" DROP COLUMN "recipe_id"`);
    await queryRunner.query(
      `ALTER TABLE "ingredient" ADD "ingredientItemPriceId" integer`
    );
