export class ProfitMapper {
  static toRecipes(response) {
    ...
    return {
      ...
      profitLoui:
        (finalItem.louiHQPrice || finalItem.louiPrice) * response.amountResult -
        ingredientsTotalPrice,
      profitChaos:
        (finalItem.chaosHQPrice || finalItem.chaosPrice) *
          response.amountResult -
        ingredientsTotalPrice,
      profitListed:
        (finalItem.minHQPriceListed || finalItem.minPriceListed) *
          response.amountResult -
        ingredientsTotalPrice,
    };
  }
